...
SOURCES += \
    ...
    platform/fullscreen_detect_x11.cpp \
...
unix:!macx {
    ...
    PKGCONFIG += x11 xi
    # portable install layout: find our own shared libs next to the binary
    # (lib/ subdir) without requiring LD_LIBRARY_PATH or a wrapper script
    QMAKE_LFLAGS += -Wl,-rpath,\'\$$ORIGIN/lib\',-rpath,\'\$$ORIGIN\'
}
