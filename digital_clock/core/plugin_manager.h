...
public slots:
   ...
   * @param parent - widget to use as a parent for plugin's dialog
   * @see PluginBase::SetDialogParent()
   */
  void ConfigurePlugin(const QString& name, QWidget* parent = nullptr);
