...
private slots:
  ...
  void OnWindowTargetScreenChanged(const QString& screenId);
...
private:
  ...
  core::PluginManager* plugin_manager_ = nullptr;

  gui::TrayControl* tray_control_;
  MouseTracker* mouse_tracker_;

  QTimer timer_;
  QString preferred_screen_id_;
  int next_legacy_window_id_ = 1;
