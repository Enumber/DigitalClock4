...
static void init_ip_address_resources() { Q_INIT_RESOURCE(ip_address_lang); }

namespace ip_address {

IpAddressPlugin::IpAddressPlugin() : ip_update_timer_(nullptr), getting_external_ip_(false)
{
  init_ip_address_resources();
  InitTranslator(QLatin1String(":/ip_address/lang/ip_address_"));
