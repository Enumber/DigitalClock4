...
static void init_talking_clock_resources() { Q_INIT_RESOURCE(talking_clock_lang); }
...
{
  init_talking_clock_resources();
  InitTranslator(QLatin1String(":/talking_clock/lang/talking_clock_"));
