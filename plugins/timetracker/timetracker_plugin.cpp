...
static void init_timetracker_resources() { Q_INIT_RESOURCE(timetracker_lang); }
...
{
  // qrc prefix is "/timetracker/lang" — the "lang/" part was missing here, so
  // this plugin's translations never loaded, in any language
  init_timetracker_resources();
  InitTranslator(QLatin1String(":/timetracker/lang/timetracker_"));
