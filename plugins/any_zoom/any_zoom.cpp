...
static void init_any_zoom_resources() { Q_INIT_RESOURCE(any_zoom_lang); }
...
AnyZoom::AnyZoom()
{
  ...
  init_any_zoom_resources();

  InitTranslator(QLatin1String(":/any_zoom/lang/any_zoom_"));
...
{
  ZoomDialog* settings_dlg = new ZoomDialog(DialogParent());
