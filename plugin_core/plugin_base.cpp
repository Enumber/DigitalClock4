...
#include <QIcon>
// QPointer<QWidget> is dereferenced here, and the header only forward declares
// QWidget: without the full definition static_cast to/from QObject* is ill-formed
#include <QWidget>
...
void PluginBase::SetDialogParent(QWidget* parent)
{
  dialog_parent_ = parent;
}

QWidget* PluginBase::DialogParent() const
{
